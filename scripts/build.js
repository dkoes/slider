...
function getSliderDefaults(config, appVersion) {
  ...
  return {
    ...
    posterSlidesControlsAlwaysVisible: booleanValue(config.poster_slides_controls_always_visible, false),
...
function formatSliderDefaults(defaults) {
  ...
  const assignments = [
    ...
    ["SLIDER_POSTER_SLIDES_CONTROLS_ALWAYS_VISIBLE", defaults.posterSlidesControlsAlwaysVisible],
